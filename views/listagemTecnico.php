...
<body>
    <main>
                ...
                foreach ($tecnicos as $tecnico){
                    ...
                    echo" 
                        <div class = 'card'>
                            ...
                            <img class = 'tecnico' src = '../images/selecao-icon.jpeg'>
                            ...
                            <div class='content'>
                                ...
                                <div class='text'>
                                    ...
                                    <p class='valor'>{$tecnico['titulos']}</p>
                                </div>

                                <div class='div-buttons'>
                                    <a href='$caminho/tecnico/editar/{$tecnico['id']}'><button class='crud-buttons update-button'>Alterar</button></a>
                                    <a href='$caminho/tecnico/excluir/{$tecnico['id']}'><button class='crud-buttons delete-button'>Excluir</button></a>
                                </div>
        ...
        <div class="area">
            <a href="<?php echo APP."tecnico/novo";?>"><button class="crud-buttons create-button">Criar</button></a>
        </div>
    </main>
