...
<body>
    <main> 
        <form action="<?php echo APP; ?>tecnico/salvar" method="post">
            <h3>Inserir Clube</h3>
            <input readonly type="text" class="form-control" id="id" name="id" value='<?php echo "{$tecnico['id']}"; ?>'>
            <input type="text" name="nome" placeholder="Nome" value='<?php echo "{$tecnico['nome']}"; ?>' required>
            <input type="number" name="titulos"  placeholder="Títulos" value='<?php echo "{$tecnico['titulos']}"; ?>'required>
